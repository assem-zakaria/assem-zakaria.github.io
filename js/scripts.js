  ...
  (function () {
	...
	// GSAP Main Function (this function called after making sure the page is scrolled to top)
		...
		function startGSAP() {
	  	...
	  	//	Set the step texts and svg for all steps except the first one keep it showed
		  	Array.from(step_text_els).slice(1).forEach(el => {
