...
*/
  ...
  (function () {
  	...
  	//	Variables
	  	...
	  	const signup_el = document.querySelector("section.hero .signup-cont")
	...
	// GSAP Main Function (this function called after making sure the page is scrolled to top)
		...
		function startGSAP() {
			//	GSAP Sets
			  	...
			  	//	Set the step texts and svg for all steps except the first one
