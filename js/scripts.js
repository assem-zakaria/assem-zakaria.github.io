...
*/
  ...
  (function () {
  	...
  	//	Variables
	  	...
	  	const scroll_down_popup = document.querySelector(".hero .scroll-down-popup");
	  	const scroll_down_popup_inner = document.querySelector(".hero .scroll-down-popup > div");

	  	const hero_table_el = document.querySelector("section.hero table");

	  	//	Signup Logo Elements
	  	const signup_cont = document.querySelector(".signup-cont");
	  	const signup_logo = document.querySelector(".signup-cont > svg");
	  	const signup_form = document.querySelector(".signup-cont .form-cont");
		...
		function startGSAP() {
	  	...
	  	//	Hide all steps text and svg icons
		  	step_text_els.forEach(el => {
				    gsap.set(el.querySelectorAll("span")[0],
				    	{
				    		autoAlpha: 0,
				    		yPercent: 100
				    });
				    ...
				    if (el.querySelectorAll("span")[1]) {	// second span in step text (subheading)
					    gsap.set(el.querySelectorAll("span")[1],
					    	{
					    		autoAlpha: 0,
					    		yPercent: 500
					    });
		  ...
		  //	Hide the purple logo part of the signup SVG logo
			...
			//	Hide form cont childrens
			  gsap.set(signup_form.children, {
			    autoAlpha: 0,
			    y: 50,
			  });

			//	Hide scroll down popup
			  gsap.set(scroll_down_popup_inner, {
			    autoAlpha: 0,
			    y: 30,
			  });
			  ...
			  const boxElements = [
				...
				//	Scroll Trigger Timeline
					...
					//	Show second main text
						scrub_timeline.to(step_text_els[1].querySelectorAll('span')[0], {
						    autoAlpha: 1,
						    yPercent: 0,
						    duration: 3,
						    ease: "power2.inOut",
					...
					//	Show second subheading text
						scrub_timeline.to(step_text_els[1].querySelectorAll('span')[1], {
						    autoAlpha: 1,
						    yPercent: 0,
						    duration: 3,
						    ease: "power2.inOut",
					...
					//	Show the Signup SVG logo from bottom to up
						scrub_timeline.fromTo(signup_logo, 
							{
						    autoAlpha: 0,
						    yPercent: 50,
						  },
					...
					//	Show the Signup form from bottom to up
						scrub_timeline.fromTo(signup_form, 
							{
						    autoAlpha: 0,
						    yPercent: 50,
						  },
