	...
	// GSAP Main Function (this function called after making sure the page is scrolled to top)
		...
		function startGSAP() {
	  	...
	  	//	Hide all steps text and svg icons
			...
			//	Hide the table
		  	gsap.set(hero_table_el, { autoAlpha: 0, scale: 0.5 });
		  ...
		  //	Hide the purple logo part of the signup SVG logo
			...
			//	Hide Parts Calculator
			  gsap.set(parts_calc_el, { autoAlpha: 0,  scale: 0.7});
		  ...
		  // Array of elements
			...
			//	Scroll Trigger Timeline
					...
					//	Show Parts Calculator
						scrub_timeline.to(parts_calc_el, 
				  		{ 
				  			autoAlpha: 1,
				  			scale: 1,
				  			duration: 3,
					...
					//	Show third main text
						scrub_timeline.to(step_text_els[2].querySelectorAll('span')[0], {
						    autoAlpha: 1,
						    yPercent: 0,
						    duration: 3,
						    ease: "power2.inOut",
					...
					//	Show third subheading text
						scrub_timeline.to(step_text_els[2].querySelectorAll('span')[1], {
						    autoAlpha: 1,
						    yPercent: 0,
						    duration: 3,
						    ease: "power2.inOut",
